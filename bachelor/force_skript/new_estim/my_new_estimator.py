...
def main():
    ...
    # 2) Startwerte für a, b, c
    #    Hier kannst du deine bisherigen Grid-Search-Ergebnisse als Startpunkt nehmen.
    theta0 = np.array([30.0, 2.0, -2.0])  # [a, b, c]

    # Optional: Bounds setzen, z.B. a>0, b>0
    lower_bounds = [0.0, 0.0, -np.inf]
    upper_bounds = [np.inf, np.inf, np.inf]

    # 3) Nichtlineare Least-Squares-Optimierung
    ...
    # 4) Simulation mit den gefundenen Parametern und Plot
